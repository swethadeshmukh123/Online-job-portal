...
<head>
    ...
    <meta property="og:image:alt" content="Jobs Portal" />
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Ramohalli Cross <br/> near Bidadi <br/>Bengaluru</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:nightingale.nath2@gmail.com">rrcestudents@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+233 546 607 474">+911234567899</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Jobs Portal</h5>
											<p>Our Job portal is a online job management system developed by Team of Students of RRCE for their project in October 2022.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : Ramohalli Cross, near Bidadi Bengaluru</p>
								<p>Email : <a href="mailto:nightingale.nath2@gmail.com">rrcestudents@gmail.com</a></p>
								<p>Phone : <a href="tel:+233546607474">+911234567899</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Students Vision Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by RRCE Students</a></li>
								</ul>
