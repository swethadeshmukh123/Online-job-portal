...
<head>
	...
	<title>Jobs Portal - <?php echo "$compname"; ?></title>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Email : <a href="mailto:nightingale.nath2@gmail.com">rrcestudents2@gmail.com</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> SStudents Vision Software</p>
